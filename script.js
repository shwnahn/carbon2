document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleEvent(eventId) {
        switch(eventId) {
            case 1:
                lastEvent = "정부에서 배출권 과잉공급을 통제하기 시작했습니다. 이제 정부에게서 온실가스 배출권을 살 수 없습니다!";
                showModal(lastEvent);
                break;
            case 2:
                lastEvent = "정부에서 온실가스 배출권을 구매합니다! 개당 100,000원에 구매합니다. 판매하세요!";
                showModal(lastEvent);
                break;
            case 3:
                ...
                break;
            case 4:
                lastEvent = "정부가 친환경 사업을 진행하는 기업에게 보조금을 줍니다. 배출효율을 2번 이상 높인 팀이 모두 100,000원을 받습니다.";
                showModal(lastEvent);
                break;
            case 5:
                lastEvent = "정부에서 산업보조금을 지급합니다. 가위바위보에서 이긴 한 팀이 200,000원을 받습니다.";
                showModal(lastEvent);
                break;
            case 6:
                ...
                break;
            case 7:
                lastEvent = "태풍피해로 인하여 제품을 생산하지 못한 기업에게 재난지원금이 지원되었습니다. 가장 돈이 적은 플레이어에게 자금 + 200,000원";
                showModal(lastEvent);
                break;
            default:
                lastEvent = "없음";
